...
int main()
{
   _tn::composite_password_generator generator;
   generator.add(std::make_unique<_tn::symbol_generator>(2));
   generator.add(std::make_unique<_tn::digit_generator>(2));
   generator.add(std::make_unique<_tn::upper_letter_generator>(2));
   generator.add(std::make_unique<_tn::lower_letter_generator>(4));
